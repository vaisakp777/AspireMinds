      ...
      <section className="level-section">
        ...
        <div className="curriculum-grid">
          <div className="curriculum-card secondary">
            <div className="card-icon-placeholder"><img  src="../../images/peaceful.jpg"  alt="System Access icon placeholder" className='card-icon'></img></div>
            <h3>
        ...
        <div className="curriculum-grid">
          ...
          <div className="curriculum-card primary">
            <div className="card-icon-placeholder"><img src="../../images/path.jpg" alt="Meditation icon placeholder" className='card-icon'></img></div>
            <h3>
